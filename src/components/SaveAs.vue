...
const saveAs = async () => {
    // This is the tauri plugin for file saving
    ...
    try {
        ...
        // The function return void when everythings is okay, otherwise; return error string
        const zip = await invoke<string>("zip_command", {
            zipPath,
            filesName: [
                "assets",
                "env",
